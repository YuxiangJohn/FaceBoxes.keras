...
img_height = 1024 # Height of the model input images
img_width = 1024 # Width of the model input images
...
scales = [0.03125, 0.25, 0.5, 1]
aspect_ratios = [[1.0],
                 [1.0],
                 [1.0]] # The anchor box aspect ratios used in the original SSD300; the order matters
two_boxes_for_ar1 = False
steps=[32, 64, 128] # The space between two adjacent anchor box center points for each predictor layer.
...
#############create model and load trained VGG-16 weights into it
...
'''
model_checkpoint = ModelCheckpoint(filepath='saved_model/ssd300_pascal_07+12_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
...
model_checkpoint = ParallelModelCheckpoint(model ,filepath='saved_model/ssd300_pascal_07+12_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}_single.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
                                   save_weights_only=False,
